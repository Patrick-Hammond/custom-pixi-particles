...
export default class ColorBehaviour extends Behaviour {
    ...
    sinus = false;
    // New properties
    colorStops = []; // Multi-gradient stops
    ...
    applyColorStops = (particle, lifeProgress) => {
    ...
    applyPerlinColor = (particle, lifeProgress) => {
    ...
    applyPulseEffect = (particle, lifeProgress) => {
