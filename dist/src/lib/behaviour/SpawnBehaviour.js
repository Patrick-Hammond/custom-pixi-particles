...
export default class SpawnBehaviour extends Behaviour {
    ...
    priority = 0;
    overOne = false;
    trailProgress = 0; // Progress along the trail (0-1)
     ...
     */
    calculateTrailRangePositions = (point) => {
        const positions = [];
     ...
     * @param {Object} point - The custom point configuration.
     */
    spawnParticleAtPoint = (particle, point) => {
    ...
    calculateTrailPosition = (point, overrideProgress) => {
