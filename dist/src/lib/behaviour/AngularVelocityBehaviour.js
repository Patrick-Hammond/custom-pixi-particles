...
export default class AngularVelocityBehaviour extends Behaviour {
    ...
    minRadius = 0;
    minRadiusVariance = 0;
    oscillate = false; // Oscillate angular velocity
    oscillationSpeed = 1; // Speed of oscillation
    oscillationAmplitude = 10; // Amplitude of oscillation in degrees
    linearRadiusReduction = true; // Linear or exponential radius reduction
    dynamicRadius = false; // Allow dynamic radius changes during lifetime
    /**
